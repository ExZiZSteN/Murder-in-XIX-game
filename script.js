...
const locations = [
    ...
    {
        name: "Шериф",
        text: "Шериф расказывает вам про убиствах людей в городе одна из жертва была помощником шерифа у него есть пара подзоваемых - Завсегдатый бара и Дровосек, единственные зацепки это бутылка Виски на местах преступлений и грубые раны на жертвах. Вы заментили рядом с ним бутылки с алкоголем"
    },
    {
