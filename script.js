...
const locations = [
    ...
    {
        name: "Шериф",
        text: "Шериф расказывает вам про убиствах людей в городе одна из жертва была помощником шерифа у него есть пара подзоваемых - Завсегдатый бара и Дровосек, единственные зацепки это бутылка Виски на метсах престпулений и грубые рана на жертвах.Вы заментили рядом с ним бутылки с алкоголем"
    },
    {
...
function dead(){
    if (shovel === 0){
        ...
        text.innerHTML = "Вы выкапывете яму и находу там труп дровосека, еще одна жертва? Тщательно осмотрев его вы замечаете"
    }
}
function goVillage() {
    update(locations[8]);
